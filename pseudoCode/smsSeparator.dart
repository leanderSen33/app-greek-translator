...
String sms = "Hola pepe soy enrique-ramos/El-toro/David-Moreno:23.22E:reto/test como estas?";
...
//         print(group);
        if(index<listOfSeparators.length && group.contains(listOfSeparators[index])){
          checkSeparator(index, group);
          if(ListOfGroup.last!=group){addToFinalList(separator);}
        }else{
